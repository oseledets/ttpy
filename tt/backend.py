    ...
    def svd(self, a, full_matrices=False):
        ...
        try:
            ...
            if a.is_cuda:
                ...
                # decaying spectra a TT unfolding produces; the QR-based gesvd
                # driver is solid there.  Retry on the device before paying for
                # a host round trip, which for a large unfolding costs seconds
